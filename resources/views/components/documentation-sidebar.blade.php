<div class="sticky top-28 space-y-6">
    ...
    <div class="bg-slate-100 p-6 rounded-xl border border-slate-100">
        ...
        <div class="space-y-3">
            @if ($documentation->attachment)
                ...
                <a href="{{ asset('storage/' . $file) }}" target="_blank"
                    class="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-200/50 hover:border-blue-400 transition group">
        ...
        <p class="mt-4 text-[10px] text-slate-400 leading-tight">
            *File laporan bersifat transparan dan dapat diunduh oleh siapa saja.
        </p>
    </div>
    ...
    <div class="bg-blue-600 p-6 rounded-xl text-white shadow-xl shadow-blue-100">
        ...
        <a href="{{ route('donation.index') }}"
            class="block w-full py-2 bg-white text-blue-600 text-center rounded-xl font-bold hover:bg-blue-50 transition">
            Donasi Sekarang
        </a>
    </div>
</div>
